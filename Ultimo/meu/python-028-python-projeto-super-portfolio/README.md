...
- Use o comando: `git clone git@github.com:tryber/python-028-python-projeto-super-portfolio.git`
- Entre na pasta do repositório que você acabou de clonar:
  - `cd python-028-python-projeto-super-portfolio`
...
[Formulário de avaliação do projeto](https://be-trybe.typeform.com/to/ZTeR4IbH#cohort_hidden=CH28-PYTHON&template=betrybe/python-0x-projeto-super-portfolio)
...
![image](https://github.com/betrybe/python-028-python-projeto-super-portfolio/assets/78612641/33f6bffd-1ab0-46ef-b28f-7bc625ba8be2)
